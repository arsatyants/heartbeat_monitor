...
_BOARD_TUNING: dict[BoardType, dict] = {
    ...
    BoardType.RPI5: dict(
        ...
        max_wavelet_scales   = 64,  # matches CPU SignalProcessorWavelet (64 scales)
    ...
    BoardType.RPI_ZERO_2W: dict(
        ...
        max_wavelet_scales   = 32,  # 32 scales – memory-constrained
    ...
    BoardType.RPI_OTHER: dict(
        preferred_work_group = 64,
        max_wavelet_scales   = 48,  # 48 scales – balanced
        signal_buffer_limit  = 512,
        use_float16          = False,
    ),
    # Generic ARM / x86
    ...
    BoardType.UNKNOWN: dict(
        preferred_work_group = 64,
        max_wavelet_scales   = 32,  # 32 scales – unknown/constrained hardware
        signal_buffer_limit  = 512,
        use_float16          = False,
    ),
}
